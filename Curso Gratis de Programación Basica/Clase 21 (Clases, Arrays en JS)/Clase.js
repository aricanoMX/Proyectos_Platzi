class Pakiman {
  //con esto es suficiente para crear un objeto
  constructor(nombrePakiman, t, h, a) {
    // esto es como escribir  function pero no tiene nombre PD: funciona igual que una funcion
