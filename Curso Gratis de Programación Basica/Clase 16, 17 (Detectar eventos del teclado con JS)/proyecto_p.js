...
drawing_area.addEventListener("mousemove", dibujarMouse);
...
function dibujarMouse(down) {
    //console.log("Estas clicando el mouse");
    //-------------- Posición cursor --------------
    var mov_x = down.layerX;
    var mov_y = down.layerY;

    dibujarCanvas(color_linea, mov_x, mov_y, mov_x + mov, mov_y + mov, drawinga);
}